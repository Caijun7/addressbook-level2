...
public class Formatter {
    ...
    public String getRequestUserInputMessage() {
    ...
    public String formatMessages(String... messages) {
        ...
        for (String str : messages) {
            sb.append(LINE_PREFIX + str.replace("\n", LS + LINE_PREFIX) + LS);
        }
        return sb.toString();
    }

    public String getEchoCommandLineInputMessageFormat(String fullInputLine) {
        return formatMessages("[Command entered:" + fullInputLine + "]");
    }

    public String getWelcomeMessageFormat(String version, String storageFilePath) {
        String storageFileInfo = String.format(MESSAGE_USING_STORAGE_FILE, storageFilePath);
        return formatMessages(DIVIDER,
                DIVIDER,
                MESSAGE_WELCOME,
                version,
    ...
    public String getGoodbyeMessageFormat() {
        return formatMessages(MESSAGE_GOODBYE, DIVIDER, DIVIDER);
    }

    public String getInitFailedMessageFormat() {
